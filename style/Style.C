...
TStyle* IrlesStyle() 
{
  ...
  irlesStyle->SetTitleX(0.2);
  irlesStyle->SetTitleY(0.92);
  
  irlesStyle->SetLabelFont(42,"xyz");
  irlesStyle->SetLabelSize(0.04,"xyz");
  irlesStyle->SetLabelOffset(0.015,"xyz");
  irlesStyle->SetTitleFont(42,"xyz");
  irlesStyle->SetTitleSize(0.05,"xyz");
  irlesStyle->SetTitleOffset(1.1,"yz");
  irlesStyle->SetTitleOffset(1.1,"x");
